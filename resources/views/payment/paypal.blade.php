			...
			<div class="col-md-6 col-md-offset-3">
				...
				<form action="" method="post">
					...
					<div class="input-group">
						<input type="number" name="pixel" min="{{ $site['paypal_min_amount'] }}" class="form-control input-lg pixel" placeholder="2000">
...
@push('footer_js')
	<script>
		var min_pixel={{ $site['paypal_min_amount'] }};
		var discount_percentage={{ $site['paypal_discount'] }};
		var input = $('.pixel');
		var price = 0;
